...
(function($) {
	$.fn.fullpage = function(options) {
		...
		*/
		...
		$('.fp-section').each(function(index){
			...
			if (numSlides > 1) {
				...
				$(this).find('.sliderBalls').append('<div class="fp-controlArrow fp-prev"><i class="fa fa-angle-left"></i></div><div class="fp-controlArrow fp-next"><i class="fa fa-angle-right"></i></div>');
		...
		*/
		...
		$('.sliderBalls span').on('click', function(){
			 var a = $(this).attr("data-index"); 
			 $('span').removeClass('active');
            switch (a) {
			  case "1":
			    $('#section1 .sliderBalls span:nth-child(1), #section2 .sliderBalls span:nth-child(1)').addClass('active');
			    break;
			  case "2":
			    $('#section1 .sliderBalls span:nth-child(2), #section2 .sliderBalls span:nth-child(2)').addClass('active');
			    break;
			  case "3":
			    $('#section1 .sliderBalls span:nth-child(3), #section2 .sliderBalls span:nth-child(3)').addClass('active');
			    break;
			  default:
			    console.log(" nothing selected, what gives?")
			    break;
			} 
		});

		function setSliderBalls (){

				var hash = window.location.hash;
				$('span').removeClass('active');
				if (hash === "#secondPage"){

					$('#section1 .sliderBalls span:nth-child(1)').addClass('active');

				} else if (hash === "#secondPage/1"){
					$('#section1 .sliderBalls span:nth-child(2)').addClass('active');


				} else if (hash === "#secondPage/2"){

					$('#section1 .sliderBalls span:nth-child(3)').addClass('active');


				} else if (hash === "#3rdPage"){
					$('#section2 .sliderBalls span:nth-child(1)').addClass('active');
				} else if (hash === "#3rdPage/1"){
					$('#section2 .sliderBalls span:nth-child(2)').addClass('active');
				} else if (hash === "#3rdPage/2"){
					$('#section2 .sliderBalls span:nth-child(3)').addClass('active');
				}
		}

		function showBackgroundLogo (){
		...
		// Menu settings
		$('#menuToggle').html('<i class="fa fa-bars">')
		$('#menuToggle, .menu-close').on('click', function(){
			if ($('#menuToggle').hasClass('active')){
				$('#menuToggle').html('<i class="fa fa-bars">')
			} else {
				$('#menuToggle').html('<i class="fa fa-minus">');
			}
		...
		$('.menu-wrap li a').on('click', function(){
		...
		*/
		...
		$.fn.fullpage.reBuild = function(){
			...
			// sets margin for slider balls
			console.log(windowsHeight);
			var sliderBallTopMargin = (windowsHeight/2) - 120;
			console.log(sliderBallTopMargin);
			$('.sliderBalls').css('margin-top', -sliderBallTopMargin);
